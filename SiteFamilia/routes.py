...
from SiteFamilia import app, database, bcrypt
from SiteFamilia.forms import FormLogin, FormCriarConta, FormEditarPerfil, FormCriarPost
from SiteFamilia.models import Usuario, Post
...
def homepage():
    if current_user.is_authenticated:
        ...
        return render_template('homezero.html')
...
def login():
    ...
    if form_login.validate_on_submit() and 'botao_submit_login' in request.form:
        ...
        if usuario and bcrypt.check_password_hash(usuario.senha, form_login.senha_login.data):
            ...
            # flash(f'login efetuado com sucesso para o e-mail: {form_login.email_login.data}', 'alert-success')
...
def criarconta():
    ...
    if form_criarconta.validate_on_submit() and 'botao_submit_criarconta' in request.form:
        ...
        usuario = Usuario(username=form_criarconta.username.data, email=form_criarconta.email.data, senha=senha_cripto)
...
def sair():
    ...
    return redirect(url_for("homezero"))
...
def editar_perfil():
    ...
    if form.validate_on_submit():
        current_user.email = form.email_login.data
        ...
        form.email_login.data = current_user.email
